...
- [x] Update `src/compiler/backend/arm64/ir_codegen.rs` to implement `Instruction::Alloc` via calls to `aura_alloc` (the runtime API) instead of just stack reservation.
