...
declare ptr @aura_llvm_http_get_bytes_task(ptr, ptr, ptr, i64)
...
declare i32 @aura_read_file_bytes(ptr, ptr, ptr)
declare ptr @aura_llvm_read_file_bytes(ptr, i64)
declare ptr @aura_try_read_file(ptr)
declare void @aura_write_file(ptr, ptr)
declare i1 @aura_try_write_file(ptr, ptr)
declare i1 @aura_try_write_file_atomic(ptr, ptr)
declare i1 @aura_try_write_file_bytes_atomic(ptr, ptr, i64)
declare i1 @aura_llvm_try_write_file_bytes_atomic(ptr, ptr)
declare void @aura_append_file(ptr, ptr)
declare i1 @aura_file_exists(ptr)
declare i1 @aura_fs_ensure_directory(ptr)
declare ptr @aura_fs_join(ptr, ptr)
...
declare ptr @aura_gc_store_ptr(ptr, ptr, ptr)
