...
| `fun/lambda_capture_var_fun.aura`              | Mutable Fun capture: delegate call and rebinding (C20)                 |
| `fun/lambda_capture_var_ownership_stress.aura` | Mixed mutable capture GC churn (C20)                                   |
...
cargo run -p aura-cli -- run corpus/fun/lambda_capture_var_class.aura
cargo run -p aura-cli -- run corpus/fun/lambda_capture_var_array.aura
cargo run -p aura-cli -- run corpus/fun/lambda_capture_var_fun.aura
cargo run -p aura-cli -- run corpus/fun/lambda_capture_var_ownership_stress.aura
