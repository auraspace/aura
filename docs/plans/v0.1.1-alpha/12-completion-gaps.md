...
| G5  | Compiler Expert + Runtime               | Compiler-exposed network/HTTP FFI bindings with safe ownership rules                    | `std.net`/HTTP package API, compile/type diagnostics, installed CLI health example               | In progress — primitive bridge landed; typed handles open |
