...
**Out of scope C13:** async/tasks, LLVM, true borrow, Array-of-iface, full generic HashMap, K1b `github=` / K2 publish, notarized installers (design note optional via C13s).
