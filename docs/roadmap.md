...
| Compiler                    | **C0–C6i done** — C6a–C6d ownership/GC; C6c Iterable; C6f Map; C6i field Array own     |
...
| **C6e/g/h/j** | GC Array elems, enum elems, multi-error, close batch               | Planned                                    |
...
1. ~~Language surface C2–C6i~~ → next: GC Array elems · enum Array · multi-error (see `agents/debts.md`, plan C6e–C6j)
