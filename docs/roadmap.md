...
| **C22l–m** | Lower async bodies and task operations                             | **Partial** — general CFG lowering now emits a versioned frame/state model and deterministic transition dump; broader lowering, captures, and full failure propagation remain deferred |
