...
```bash
aura add auraspace/aura@v0.1.1-alpha.8 --subdir std/io
...
See the [current 0.1.1-alpha.8 release notes](../releases/0.1.1-alpha.8.md); the [0.1.0-alpha freeze](../releases/0.1.0-alpha.md) is historical.
