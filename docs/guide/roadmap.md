...
| [013](/rfc/013) | Binary distribution        | Accepted   | **Partial**                                      | Prepared `v0.1.1-alpha.5` tarballs + installer; tier-2 targets and broader native evidence remain open                                                                                                 |
...
**Shipped:** tags `v0.1.0-alpha` and `v0.1.1-alpha.5` + multi-OS tarballs; C12,
