...
| [012](/rfc/012) | CLI                        | Accepted   | **Partial**                                      | `new` / `init` / `version` / `check` / `build` / `run` / `test` / `race` / `fmt` / `emit-c` / `publish` / `update`; package UX remains bounded                                                         |
| [013](/rfc/013) | Binary distribution        | Accepted   | **Partial**                                      | Published `v0.1.0-alpha` and `v0.1.1-alpha.3` tarballs + installer; tier-2 targets and broader native evidence remain open                                                                             |
...
**Shipped:** tags `v0.1.0-alpha` and `v0.1.1-alpha.3` + multi-OS tarballs; C12,
**C13**, S2, and the bounded v0.1.1-alpha.3 release scope are closed.
