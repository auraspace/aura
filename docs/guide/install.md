...
The public `0.1.1-alpha.4` GitHub Release assets are available for the supported
...
$AURA_HOME/
  versions/
    ...
    0.2.0/
      bin/aura
      …
  current -> versions/0.1.1-alpha.4     # active toolchain
  bin/
...
# AURA_VERSION=0.1.1-alpha.4 bash scripts/install-smoke.sh --from-release
```
...
- [CLI](./cli.md)
- [Release notes 0.1.1-alpha.4](../releases/0.1.1-alpha.4.md)
