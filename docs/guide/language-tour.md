...
- LLVM backend as default ([RFC-004](/rfc/004) — C remains the default compatibility backend; LLVM is available for complete MIR programs and the implemented scheduler-backed task/frame subset)
