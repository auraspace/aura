...
Preferred install: the **one-liner** for the current [0.1.1-alpha.5](../releases/0.1.1-alpha.5.md). Full layout and switches: [Install](./install.md).
...
# pin: curl -fsSL https://aura.fadosoft.com/install.sh | AURA_VERSION=0.1.1-alpha.5 bash
