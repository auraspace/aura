...
| Runtime             | `runtime/runtime.c` | Linked into native builds                          |
...
Site production deploys via `.github/workflows/deploy-site.yml` to **Cloudflare Pages** (`https://aura.pilotworks.dev`). See [`site/README.md`](https://github.com/auraspace/aura/blob/main/site/README.md).
