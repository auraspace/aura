...
For the current public **0.1.1-alpha.3** release, prefer the installer (versioned under `~/.aura`):
...
Details: [Install](./install.md). Current release notes: [0.1.1-alpha.3](../releases/0.1.1-alpha.3.md); the [0.1.0-alpha notes](../releases/0.1.0-alpha.md) are historical.
