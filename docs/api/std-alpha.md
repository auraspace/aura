...
| `std.reflect`                                         | Locked placeholder                     | Names and value shapes exist; calls fail with a placeholder error                                                                                              |
| `std.tls`, `std.udp`, `std.websocket`, `std.compress` | Locked placeholder                     | Transport/protocol shapes exist; backends and parsers are not wired                                                                                            |
