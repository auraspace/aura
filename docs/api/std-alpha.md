...
| `std.json` bounded value core                         | Bounded implementation                 | Validation, escaping, root classification, clone, byte length/depth, bounded options, typed outcomes, and source-backed traversal are implemented; generic mapping remains open |
