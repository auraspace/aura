...
| RFC-009/RFC-010 | User derive/macro expansion                                                | Built-in derives and registered `UserDerive`/`UserMacro` AST expansion implemented; source macros deferred | Token-tree macro ABI and out-of-process sandbox                                     |
