...
| RFC-006         | Worker scheduler, async I/O, concurrent GC                                 | OS-worker M:N pool, POSIX reactor, and executor-safe GC implemented | Concurrent tracing collector, cross-platform backends, and scheduler policy beyond POSIX |
