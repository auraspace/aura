...
| Locked direct-origin dependency consumption                     | **Implemented** (Git/HTTPS/SSH origins, immutable revision/checksum pins, semver tag selection, cache extraction; proxy serving remains deferred)                  |
